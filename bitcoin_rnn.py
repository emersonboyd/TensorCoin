...
MODEL_NAME = 'test.h5'
PULL_MODEL = '30_days_to_1_day_in_minutes.h5'
...
def run():
    ...
    create_model = False
    segment_unit = 'minute'
    df_train, df_test = segment_data(df, 'minute',100,70,segment_unit)
    ...
    if create_model:
        ...
        regressor = train_data(np.reshape(train_input, (len(train_input), 1, 1)), train_output)
        # load the regressor
    else:
    ...
    draw_data(df_test, predicted_price,segment_unit)
